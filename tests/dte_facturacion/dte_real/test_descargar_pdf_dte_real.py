...
class TestDescargarPdfDteReal(AbstractDteFacturacion):
    """
    Clase de prueebas para descargar un PDF de un DTE real.
    """
    ...
    def test_descargar_pdf_dte_real(self):
        """
        Método de test para descargar un PDF asociado a un DTE real.
        """
        try:
            ...
            # Se descarga el PDF del DTE real.
            response = self.dte.get_pdf_dte_real(
                dte_dict[0]['dte'],
                dte_dict[0]['folio'],
                dte_dict[0]['emisor']
            )
            ...
            output_dir = os.path.join(base_dir, 'archivos', 'dte_facturacion', 'dte_real_pdf')
            ...
            if self.verbose:
                print(
                    'test_descargar_pdf_dte_real() filename: ',
                    filename
                )
